            ...
            <div className="">
                <div className="footer-row">
                    <div className="footer-column">
                        ...
                        <a className="footerlink" href="https://www.instagram.com/kahlfit_/"><FiInstagram /> @kahlfit_</a>
                    ...
                    <div className="footer-column">
                        ...
                        <ul>
                            <li className="footertext">Wednesday 4 PM - 9 PM</li>
                            <li className="footertext">Friday 4 PM - 9 PM</li>
                            <li className="footertext">Saturday 12 PM - 3 PM</li>
                        </ul>
                    </div>
                    <div className="footer-column">
